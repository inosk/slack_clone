...
const PreferencesDialog = () => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="msx-w-xs md:w-fit">
        <DialogTitle>
        ...
        <Tabs orientation="horizontal" defaultValue="themes">
          ...
          <TabsContent className="max-w-xs md:max-w-fit" value="themes">
            ...
            <Typography
              variant="p"
              className="pb-4"
              text="Choose if slackzz appearance should be light or dark, or follow hte computer settings"
            />
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <Button
                variant="outline"
                onClick={() => selectColor('green')}
                className="w-full hover:border-gray-800 border-2"
              >
                Green
              </Button>
            </div>
