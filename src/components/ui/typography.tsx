...
// HTMLAttributes<HTMLEllement> をマージして
// html tagが受け取るpropsをすべて受け取れるようにする
type Props = {
...
// props にはほぼ HTMLAttributes<HTMLElement> の内容がはいる
const Typography = ({ variant = 'h1', text, className, ...props }: Props) => {
  const classNames = {
